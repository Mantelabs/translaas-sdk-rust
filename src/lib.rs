...
//! offline ZIP, report-missing, and validate-api-key calls. Service helpers arrive
//! in later releases. Behavioral parity targets are documented in the umbrella
